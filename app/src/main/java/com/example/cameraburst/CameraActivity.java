...
public class CameraActivity extends AppCompatActivity {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            setupCamera(width, height,front);
            connectCamera();
        }
    ...
    private final int totalImagesToCapture = 100;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView flip = (ImageView) findViewById(R.id.switch_btn);
        ImageView rec_txt = (ImageView) findViewById(R.id.rec_txt);
        ...
        flip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setupCamera(mTextureView.getWidth(), mTextureView.getHeight(),front);
                connectCamera();
            }
        });
        createVideoFolder();
        ...
        mRecordImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsRecording || mIsTimelapse) {
                    ...
                    rec_txt.setVisibility(View.INVISIBLE);
                    mIsRecording = false;
                    mIsTimelapse = false;
                    ...
                    rec_txt.setVisibility(View.VISIBLE);
                    mIsRecording = true;
                    flag = true;
                    mRecordImageButton.setImageResource(R.drawable.stop_btn);
...
//    }
    ...
    private void setupCamera(int width, int height, int front) {
        ...
        try {
            ...
            for(String cameraId : cameraManager.getCameraIdList()){
                ...
                int cmc = CameraCharacteristics.LENS_FACING_BACK;
